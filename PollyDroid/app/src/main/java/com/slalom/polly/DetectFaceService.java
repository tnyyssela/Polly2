...
public class DetectFaceService extends IntentService{
    ...
    public static final String PERSON_GROUP_EXTRA = "personGroup";
    public static final String PENDING_RESULT_EXTRA = "pending_result";
    public static final String FACE_URI_EXTRA = "faceUri";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            try {
                ...
                String personGroupResult = createPersonGroup(PERSON_GROUP_ID_EXTRA);

                result.putExtra(PERSON_GROUP_EXTRA, personGroupResult);
    ...
    private String createPersonGroup (String personGroupId) throws MalformedURLException {
